...
setr "status-left" "#{?client_prefix,#[bg=$onedark_blue],#[bg=$onedark_green]}#[fg=$onedark_visual_grey]#[bold] #S #{?client_prefix,#[fg=$onedark_blue],#[fg=$onedark_green]}#[bg=$onedark_black,nobold,nounderscore,noitalics]"
